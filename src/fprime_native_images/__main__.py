...
def main():
    ...
    parser.add_argument("--meta-package", required=True, type=str, help="Name of meta-package to create")
    ...
    try:
        ...
        build_packages_from_directory(
            ...
            arguments.outdir,
            "" if list(arguments.directory.glob("*.jar")) else arguments.package_tag,
